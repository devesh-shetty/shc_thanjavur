...
import shctnj0407.wixsite.com.shc_thanjavur.helper.TouchImageView;
...
//        lblDate = (TextView) v.findViewById(R.id.date);
        ...
        images = (ArrayList<Item>) getArguments().getSerializable("images");
    ...
    public class MyViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            TouchImageView imageViewPreview = (TouchImageView) view.findViewById(R.id.iv_preview);

            Item image = images.get(position);

            Glide.with(getActivity()).load(image.getImgDrawableSrc())
                    .thumbnail(0.5f)
                    .crossFade()
